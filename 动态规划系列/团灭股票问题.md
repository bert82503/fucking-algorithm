...
[动态规划核心套路](../第零章、核心框架汇总/04.动态规划解题套路框架.md) 说过，动态规划算法本质上就是穷举「状态」，然后在「选择」中选择最优解。
...
这个疑问很正确，因为我们前文 [动态规划答疑篇](../动态规划系列/03.最优子结构原理和 DP 数组遍历方向.md) 有介绍 `dp` 数组的遍历顺序是怎么确定的，主要是根据 base case，以 base case 为起点，逐步向结果靠近。
